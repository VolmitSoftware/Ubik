...
public class J {
    ...
    public static <T, R> R attemptFunction(NastyFunction<T, R> r, T param, R onError) {
        try {
            ...
            BukkitUbik.error("Failed to run function: " + e.getMessage());
        }
    ...
    public static void s(Runnable r) {
        Bukkit.getScheduler().scheduleSyncDelayedTask(BukkitUbik.instance, r);
    }
    ...
    public static void s(Runnable r, int delay) {
        Bukkit.getScheduler().scheduleSyncDelayedTask(BukkitUbik.instance, r, delay);
    }
    ...
    public static int sr(Runnable r, int interval) {
        return Bukkit.getScheduler().scheduleSyncRepeatingTask(BukkitUbik.instance, r, 0, interval);
    }
    ...
    public static void a(Runnable r, int delay) {
        Bukkit.getScheduler().scheduleAsyncDelayedTask(BukkitUbik.instance, r, delay);
    }
    ...
    public static int ar(Runnable r, int interval) {
        return Bukkit.getScheduler().scheduleAsyncRepeatingTask(BukkitUbik.instance, r, 0, interval);
    }
